...
const siteSettingsSchema = new mongoose.Schema({
  ...
  categories: {
    ...
    default: [
      { id: 'mobiles', name: 'Mobiles', icon: '📱', slug: 'mobiles', isActive: true },
      { id: 'cars', name: 'Cars', icon: '🚗', slug: 'cars', isActive: true },
      { id: 'motorcycles', name: 'Motorcycles', icon: '🏍️', slug: 'motorcycles', isActive: true },
      { id: 'electronics', name: 'Electronics', icon: '💻', slug: 'electronics', isActive: true },
      { id: 'furniture', name: 'Furniture & Home', icon: '🛋️', slug: 'furniture', isActive: true },
      { id: 'fashion', name: 'Fashion & Beauty', icon: '👗', slug: 'fashion', isActive: true },
      { id: 'others', name: 'Others', icon: '📦', slug: 'others', isActive: true },
    ]
  },
