...
export default function SignupPage() {
  ...
  const handleSignup = async (e) => {
    ...
    if (!recaptchaToken) {
      toast.error('Please complete the reCAPTCHA'); return
    }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          <Link href="/" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
            {settings?.logoUrl ? (
          ...
          <p style={{ fontSize: '13px', color: '#9CA3AF', fontFamily: 'Inter, sans-serif', marginTop: '4px' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          <h1 style={{
            ...
            fontFamily: 'Inter, sans-serif', letterSpacing: '-0.02em', marginBottom: '6px',
          }}>Create account</h1>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
          ...
          <span style={{ fontSize: '12px', color: '#9CA3AF', fontFamily: 'Inter, sans-serif', fontWeight: '500' }}>or sign up with email</span>
          <div style={{ flex: 1, height: '1px', background: '#E5E7EB' }} />
        </div>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <input
                ...
                placeholder="Re-enter password" className="auth-input"
                style={{ width: '100%', padding: '11px 44px 11px 14px', border: '1.5px solid #E5E7EB', borderRadius: '10px', fontSize: '14px', fontFamily: 'Inter, sans-serif', outline: 'none', boxSizing: 'border-box' }}
              />
              <button type="button" onClick={() => setShowConfirm(!showConfirm)} style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: '#9CA3AF' }}>
                {showConfirm ? '🙈' : '👁️'}
              </button>
            </div>
            {/* Password match indicator */}
            {confirmPassword && (
              <p style={{ fontSize: '12px', marginTop: '4px', fontFamily: 'Inter, sans-serif', color: password === confirmPassword ? '#10B981' : '#EF4444' }}>
        ...
        <p style={{ fontSize: '11px', color: '#9CA3AF', textAlign: 'center', marginTop: '16px', fontFamily: 'Inter, sans-serif', lineHeight: '1.6' }}>
          By creating an account, you agree to our{' '}
          <Link href="/terms" style={{ color: 'var(--brand-primary)' }}>Terms</Link>
          {' '}and{' '}
          <Link href="/privacy-policy" style={{ color: 'var(--brand-primary)' }}>Privacy Policy</Link>
        </p>
      </div>
    </div>
  )
