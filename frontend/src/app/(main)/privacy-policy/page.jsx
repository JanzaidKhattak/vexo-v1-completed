    ...
    <div>
      ...
      <div className="page-container" style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        ...
        <div style={{ background: 'var(--bg-secondary)', borderRadius: '12px', padding: '24px', textAlign: 'center', border: '1px solid var(--border-default)', marginTop: '8px' }}>
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px', color: 'var(--text-secondary)', marginBottom: '12px' }}>Have privacy concerns or want to delete your data?</p>
          <a href="/help" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '10px 20px', background: 'var(--brand-primary)', color: 'white', borderRadius: '8px', textDecoration: 'none', fontSize: '14px', fontWeight: '600', fontFamily: 'Inter, sans-serif' }}>Contact Us →</a>
        </div>
      </div>
    </div>
  )
