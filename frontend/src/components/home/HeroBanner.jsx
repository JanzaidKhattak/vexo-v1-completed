...
export default function HeroBanner() {
  ...
  return (
    <section style={{
      background: bannerImage ? `linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.65)), url('${bannerImage}') center/cover no-repeat` : '#111827',
      padding: '72px 0 64px',
      position: 'relative',
      overflow: 'hidden',
    }}>
      ...
      <div className="page-container" style={{ position: 'relative', textAlign: 'center' }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '12px', fontWeight: '500', color: 'rgba(255,255,255,0.8)', fontFamily: 'Inter, sans-serif', letterSpacing: '0.02em' }}>
        ...
        <p style={{
          ...
          fontFamily: 'Inter, sans-serif', marginBottom: '36px', fontWeight: '400',
        }}>
          {subheading}
        </p>
        ...
        <form onSubmit={handleSearch} style={{
          ...
          <button type="submit" style={{
            padding: '14px 24px', background: 'var(--brand-primary)',
        ...
        <div style={{ display: 'flex', gap: '40px', justifyContent: 'center', marginTop: '48px', flexWrap: 'wrap' }}>
          {[
            ...
            <div key={stat.label} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '22px', fontWeight: '800', color: 'white', fontFamily: 'Inter, sans-serif', letterSpacing: '-0.02em' }}>{stat.value}</div>
              <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.45)', fontFamily: 'Inter, sans-serif', marginTop: '2px' }}>{stat.label}</div>
            </div>
          ))}
        </div>
